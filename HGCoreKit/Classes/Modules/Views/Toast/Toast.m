...
//  KIWComSDK
//
//  Created by GangHuang on 9/6/23.
//
...
+ (Toast *)show:(NSString *)msg{
    UIView *view = [UIScreen currentWindow];
    
    return [self show:msg adjustY:0 inView:view];
}
...
+ (Toast *)show:(NSString *)msg
    ...
    return [self show:msg adjustY:0 inView:superView];
}
